...
public abstract class GymMember
{
 ...
 public GymMember(int id, String name, String location, String phone, String email, String gender, String DOB, String membershipStartDate) {
    ...
    public void activateMembership(){
     ...
     System.out.println("you have successfully activated your membership");
    }
    ...
    public void deactiveMembership(){
        if(this.activeStatus== true){
            this.activeStatus=false;
            System.out.println("your membership has successfully been deactivated");
        }
        else
        {
    ...
    //method to reset a members data
